...
from . import views
from .profile_views import registration_profile, profile_loading
...
urlpatterns = [
    ...
    # Profile URLs
    path('profile/<str:profile_id>/', profile_loading, name='profile_loading'),
    path('profile/<str:profile_id>/view/', registration_profile, name='registration_profile'),
]
